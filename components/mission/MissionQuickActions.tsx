        ...
        {actions.map((action) => (
          <li key={action.id}>
            <button
              ...
              className="group text-foreground hover:bg-muted focus-visible:ring-ring/50 flex h-8 w-full items-center gap-2.5 rounded-lg px-2.5 text-left text-[13px] transition-colors duration-[var(--motion-fast)] focus-visible:ring-2 focus-visible:outline-none"
            >
